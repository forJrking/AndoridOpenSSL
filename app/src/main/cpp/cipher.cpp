...
Java_com_alley_openssl_util_JniUtils_encodeByHmacSHA1(JNIEnv *env, jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_alley_openssl_util_JniUtils_encodeBySHA224(JNIEnv *env, jobject instance,
                                                    jbyteArray src_) {
    jbyte *src = env->GetByteArrayElements(src_, NULL);
    jsize src_Len = env->GetArrayLength(src_);
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_alley_openssl_util_JniUtils_encodeBySHA256(JNIEnv *env, jobject instance,
                                                    jbyteArray src_) {
    jbyte *src = env->GetByteArrayElements(src_, NULL);
    jsize src_Len = env->GetArrayLength(src_);
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_alley_openssl_util_JniUtils_encodeBySHA384(JNIEnv *env, jobject instance,
                                                    jbyteArray src_) {
    jbyte *src = env->GetByteArrayElements(src_, NULL);
    jsize src_Len = env->GetArrayLength(src_);
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_alley_openssl_util_JniUtils_encodeBySHA512(JNIEnv *env, jobject instance,
                                                    jbyteArray src_) {
    jbyte *src = env->GetByteArrayElements(src_, NULL);
    jsize src_Len = env->GetArrayLength(src_);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_encodeByAES(JNIEnv *env, jobject instance, jbyteArray keys_,
                                                 jbyteArray src_) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_decodeByAES(JNIEnv *env, jobject instance, jbyteArray keys_,
                                                 jbyteArray src_) {
    LOGD("AES->对称密钥，也就是说加密和解密用的是同一个密钥");
    const unsigned char *iv = (const unsigned char *) "0123456789012345";
    jbyte *keys = env->GetByteArrayElements(keys_, NULL);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_encodeByRSAPubKey(JNIEnv *env, jobject instance,
                                                       jbyteArray keys_, jbyteArray src_) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_decodeByRSAPrivateKey(JNIEnv *env, jobject instance,
                                                           jbyteArray keys_, jbyteArray src_) {
    LOGD("RSA->非对称密码算法，也就是说该算法需要一对密钥，使用其中一个加密，则需要用另一个才能解密");
    jbyte *keys = env->GetByteArrayElements(keys_, NULL);
    jbyte *src = env->GetByteArrayElements(src_, NULL);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_encodeByRSAPrivateKey(JNIEnv *env, jobject instance,
                                                           jbyteArray keys_, jbyteArray src_) {
    LOGD("RSA->非对称密码算法，也就是说该算法需要一对密钥，使用其中一个加密，则需要用另一个才能解密");
    jbyte *keys = env->GetByteArrayElements(keys_, NULL);
    jbyte *src = env->GetByteArrayElements(src_, NULL);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_decodeByRSAPubKey(JNIEnv *env, jobject instance,
                                                       jbyteArray keys_, jbyteArray src_) {
    LOGD("RSA->非对称密码算法，也就是说该算法需要一对密钥，使用其中一个加密，则需要用另一个才能解密");
    jbyte *keys = env->GetByteArrayElements(keys_, NULL);
    jbyte *src = env->GetByteArrayElements(src_, NULL);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_alley_openssl_util_JniUtils_signByRSAPrivateKey(JNIEnv *env, jobject instance,
                                                         jbyteArray keys_, jbyteArray src_) {
    LOGD("RSA->非对称密码算法，也就是说该算法需要一对密钥，使用其中一个加密，则需要用另一个才能解密");
    jbyte *keys = env->GetByteArrayElements(keys_, NULL);
    jbyte *src = env->GetByteArrayElements(src_, NULL);
...
Java_com_alley_openssl_util_JniUtils_verifyByRSAPubKey(JNIEnv *env, jobject instance,
                                                       jbyteArray keys_, jbyteArray src_,
                                                       jbyteArray sign_) {
    LOGD("RSA->非对称密码算法，也就是说该算法需要一对密钥，使用其中一个加密，则需要用另一个才能解密");
    jbyte *keys = env->GetByteArrayElements(keys_, NULL);
...
Java_com_alley_openssl_util_JniUtils_verifySha1OfApk(JNIEnv *env, jobject instance,
                                                     jobject context) {
